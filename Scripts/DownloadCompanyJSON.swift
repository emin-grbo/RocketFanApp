...
if let lastRunFile = try? scriptsFolder.file(named: ".companyLastRun") {
...
try resourceFolder.createFile(named: "company.json", contents: json)

//Save lastRun
let lastRunFile = try scriptsFolder.createFile(named: ".companyLastRun")
