...
if let lastRunFile = try? scriptsFolder.file(named: ".rocketLastRun") {
...
try resourceFolder.createFile(named: "rocket.json", contents: json)

//Save lastRun
let lastRunFile = try scriptsFolder.createFile(named: ".rocketLastRun")
