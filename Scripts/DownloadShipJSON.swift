...
if let lastRunFile = try? scriptsFolder.file(named: ".shipLastRun") {
...
//Download time!
let url = URL(string: "https://api.spacexdata.com/v3/ships")!
let json = try Data(contentsOf: url)

//Writing file...
let resourceFolder = try Folder.current.subfolder(atPath: "RocketFan/Resources/Data")
try resourceFolder.createFile(named: "ship.json", contents: json)

//Save lastRun
let lastRunFile = try scriptsFolder.createFile(named: ".shipLastRun")
