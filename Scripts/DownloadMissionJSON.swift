...
if let lastRunFile = try? scriptsFolder.file(named: ".missionLastRun") {
...
//Download time!
let url = URL(string: "https://api.spacexdata.com/v3/missions")!
let json = try Data(contentsOf: url)

//Writing file...
let resourceFolder = try Folder.current.subfolder(atPath: "RocketFan/Resources/Data")
try resourceFolder.createFile(named: "mission.json", contents: json)

//Save lastRun
let lastRunFile = try scriptsFolder.createFile(named: ".missionLastRun")
