...
if let lastRunFile = try? scriptsFolder.file(named: ".capsuleLastRun") {
...
//Download time!
let url = URL(string: "https://api.spacexdata.com/v3/capsules")!
let json = try Data(contentsOf: url)

//Writing file...
let resourceFolder = try Folder.current.subfolder(atPath: "RocketFan/Resources/Data")
try resourceFolder.createFile(named: "capsule.json", contents: json)

//Save lastRun
let lastRunFile = try scriptsFolder.createFile(named: ".capsuleLastRun")
